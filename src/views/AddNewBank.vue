...
<template>
  <div class="address-edit-box" >
    ...
    <van-form @submit="onSubmit">
      ...
      <van-field v-model="telphone" name="telphone" label="IFSC Code" placeholder="Please fill in  the IFSC Code"
        :rules="[{ required: true, message: 'Please fill in  the IFSC Code' }]" />
      <van-field v-model="address" type="number" name="address" label="Acc Number" placeholder="Please fill in your Acc Number"
        :rules="[{ required: true, message: 'Please fill in your Acc Number' }]" />
