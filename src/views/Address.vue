...
<template>
  <div class="address-box">
    <s-header :name="'Endereço editorial'" :back="'/user'"></s-header>
    <div class="address-item">
      <van-address-list v-if="from != 'mine'" v-model="chosenAddressId" :list="list" default-tag-text="Padrão"  add-button-text ="Novo endereço"    @add="onAdd"
        @edit="onEdit" @select="select"    />
      <van-address-list v-else v-model="chosenAddressId" :list="list"  add-button-text ="Novo endereço"	     default-tag-text="Padrão" @add="onAdd"
        @edit="onEdit"  />
    </div>
  </div>
</template>
